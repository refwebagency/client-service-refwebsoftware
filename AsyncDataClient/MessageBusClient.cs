...
namespace client_service_refwebsoftware.AsyncDataClient
{
    public class MessageBusClient : IMessageBusClient
    {
        ...
        public void UpdatedClient(ClientUpdateAsyncDto clientUpdatedDto)
        {
            var message = JsonSerializer.Serialize(clientUpdatedDto);
            if(_connection.IsOpen)
            {
                Console.WriteLine("--> Updating client to MessageBus");
